package com.github.interfacefuncionais.methodreferences.exemplo2;

import com.github.interfacefuncionais.methodreferences.exemplo2.estoque.Produto;
import com.github.interfacefuncionais.methodreferences.exemplo2.estoque.ServicoInativacaoProduto;
...
//        produtos.forEach(Produto::inativar);
        ...
        var inataivacaoProduto = new ServicoInativacaoProduto();

//        produtos.forEach(produto -> inataivacaoProduto.processar(produto));
        produtos.forEach(inataivacaoProduto::processar);
