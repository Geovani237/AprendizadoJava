...
public class ItemPedido {
    ...
    public void setQuantidade(int quantidade) {
        ...
        pedido.valorTotal = pedido.getValorTotal().subtract(calcularValorTotal(this.quantidade));
        this.quantidade = quantidade;
        pedido.valorTotal = pedido.getValorTotal().add(calcularValorTotal(quantidade));
    }
