package com.github.desafios.desafiofusohorario;
...
public class ConviteFesta {
    ...
    public static void main(String[] args) {
        ...
        LocalTime horarioLocalFesta = requisitarHorario("Horário local da festa: ");

        ZonedDateTime dataFestaFusoPadrao = dataLocalFesta
                .atTime(horarioLocalFesta).atZone(ZoneId.systemDefault());
