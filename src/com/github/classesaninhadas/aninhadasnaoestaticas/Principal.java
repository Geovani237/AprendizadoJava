...
public class Principal {
    public static void main(String[] args) {
        ...
        ContaCorrente.Transacao transacao1 = conta.new Transacao("Compra no mercado", new BigDecimal("189.9"));

        ContaCorrente.Transacao transacao2 = conta.new Transacao("Academia", new BigDecimal("170"));

        System.out.println(conta.getSaldo());
        for (ContaCorrente.Transacao transacao : conta.getTransacaos()) {
